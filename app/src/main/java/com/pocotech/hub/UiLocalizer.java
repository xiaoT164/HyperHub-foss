...
public final class UiLocalizer {
    ...
    static {
        ...
        put("v2.0.0 · Утилиты HyperOS", "v2.0.0 · HyperOS toolkit");
        put("Версия 2.0.0", "Version 2.0.0");
        put("Обновл.", "Updates");
        put("Награды", "Awards");
        put("Профили", "Profiles");
        put("Живой монитор", "Live monitor");
        put("RAM, диск, температура — в реальном времени", "RAM, storage and temperature in real time");
        put("ТЕМА И НАПОМИНАНИЯ", "THEME AND REMINDERS");
        put("Акцентная тема", "Accent theme");
        put("Ежедневное напоминание", "Daily reminder");
        put("Что стоит проверить сегодня", "What to check today");
        put("Время напоминания", "Reminder time");
        put("Выключено", "Off");
        put("Что нового в 2.0", "What is new in 2.0");
        put("Пройдите интро заново", "Replay the intro");
        put("ДАННЫЕ", "DATA");
        ...
        put("Экспорт", "Export");
        put("Импорт", "Import");
        put("Экспортировано. Буфер обмена обновлён.", "Exported. Clipboard updated.");
        put("Бэкап восстановлен", "Backup restored");
        put("Импорт не удался: некорректный JSON", "Import failed: invalid JSON");
        put("Сначала скопируйте бэкап HyperHub в буфер обмена", "Copy a HyperHub backup to the clipboard first");
        put("Акцентная тема", "Accent theme");
        ...
        put("Закат", "Sunset");
        put("Графит", "Graphite");
        put("Напоминание запланировано", "Reminder scheduled");
        put("Ежедневное напоминание включено", "Daily reminder is on");
        put("ИСТОРИЯ И ДИНАМИКА", "HISTORY AND DYNAMICS");
        put("Прогонов в истории: ", "Saved runs: ");
        put("Лучший результат: ", "Best: ");
        ...
        put("Применить", "Apply");
        put("Сохранить себе", "Save as mine");
        put("Показать шаги", "Show steps");
        put("Удалить", "Delete");
        put("Профиль удалён", "Profile deleted");
        put("Профиль сохранён", "Profile saved");
        put("Новый профиль", "New profile");
        put("Введите название", "Enter a name");
        put("Выберите хотя бы один инструмент", "Pick at least one tool");
        put("Сохранить", "Save");
        put("Игровой", "Gaming");
        put("Батарея", "Battery");
        put("Чистый интерфейс", "Clean UI");
        put("Диагностика", "Diagnostics");
        ...
        put("Назад", "Back");
        put("Пропустить", "Skip");
        put("Начать пользоваться", "Start using HyperHub");
        put("Close", "Close");
        put("Закрыть", "Close");
        put("Убрано из избранного", "Removed from favorites");
        put("Telegram-канал", "Telegram channel");
